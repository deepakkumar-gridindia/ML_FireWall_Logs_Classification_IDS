...
Implemented the following classification models using the dataset chosen above. 
All the 6 ML models have been implemented on the same dataset.
...
Model Performance Comparison Table with the evaluation metrics
